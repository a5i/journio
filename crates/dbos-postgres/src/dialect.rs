//! Postgres dialect — ported 1:1 from `postgresDialect` in `dbos/dialect.go`.
//!
...
use dbos_core::dialect::{Dialect, DialectName};
...
impl Dialect for PostgresDialect {
    ...
    /// `"dbos".` — mirrors `pgx.Identifier{schema}.Sanitize() + "."`.
