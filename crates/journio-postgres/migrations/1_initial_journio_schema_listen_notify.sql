...
BEGIN
    PERFORM pg_notify('journio_notifications_channel', payload);
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;

-- Create notification trigger
CREATE TRIGGER journio_notifications_trigger
...
BEGIN
    PERFORM pg_notify('journio_workflow_events_channel', payload);
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;

-- Create events trigger
CREATE TRIGGER journio_workflow_events_trigger
