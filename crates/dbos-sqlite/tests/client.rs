//! End-to-end coverage for `dbos_core::Client` over the SQLite backend —
//! mirrors the schedule/version/client pieces of `dbos/client_test.go`. The
